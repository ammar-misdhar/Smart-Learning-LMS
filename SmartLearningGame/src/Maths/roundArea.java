 ...
 * @author mmamm
 */
public class roundArea extends javax.swing.JFrame {

    /**
     * Creates new form roundArea
     */
    ...
    public void insertToSql() {
        ...
        try {
            ...
            PreparedStatement st1 = con.prepareStatement("UPDATE `smart_learning`.`maths` SET `roundAreaComplete` = ?, `roundAreaScore` = ? WHERE (`stRegId` = '"+idPas+"');");
            // execute query
    ...
    public void Roundcm7() {
        ImageIcon icon = new ImageIcon(AcidOrBase.class.getResource("/Images/Round 7cm.png"));
        lblImage.setIcon(icon);
    }

    public void Roundcm14() {
        ImageIcon icon = new ImageIcon(AcidOrBase.class.getResource("/Images/Round 14cm.png"));
        lblImage.setIcon(icon);

    }

    public void Roundcm28() {
        ImageIcon icon = new ImageIcon(AcidOrBase.class.getResource("/Images/Round 28cm.png"));
        lblImage.setIcon(icon);

    }

    public void chack() {
        if (jTextField5.getText().equals("") && jTextField2.getText().equals("") && jTextField3.getText().equals("") && jTextField4.getText().equals("") && txtAnser.getText().equals("")) {
            ...
            //First
            if (count == 0) {
                if (jTextField5.getText().equals("7")) {
                ...
                if (jTextField4.getText().equals("7")) {
                ...
                if (txtAnser.getText().equals("154")) {
            ...
            if (count == 1) {
                ...
                if (jTextField3.getText().equals("14")) {
                    jTextField3.setBorder(BorderFactory.createLineBorder(Color.GREEN));
                } else {
                    jTextField3.setBorder(BorderFactory.createLineBorder(Color.RED));
                ...
                if (txtAnser.getText().equals("616")) {
                    txtAnser.setBorder(BorderFactory.createLineBorder(Color.GREEN));
                    score = score + 5;
            ...
            //Thired
            if (count == 2) {
                if (jTextField5.getText().equals("28")) {
                    jTextField5.setBorder(BorderFactory.createLineBorder(Color.GREEN));
                } else {
                    jTextField5.setBorder(BorderFactory.createLineBorder(Color.RED));
                ...
                if (jTextField3.getText().equals("28")) {
                    jTextField3.setBorder(BorderFactory.createLineBorder(Color.GREEN));
                } else {
                    jTextField3.setBorder(BorderFactory.createLineBorder(Color.RED));
                ...
                if (txtAnser.getText().equals("2464")) {
                    txtAnser.setBorder(BorderFactory.createLineBorder(Color.GREEN));
                    score = score + 5;
    ...
    private void initComponents() {
        ...
        lblImage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Round 7cm.png"))); // NOI18N
        ...
        lblMainObject.setText("Round Area");
 ...
 Main.MathsHub ih = new Main.MathsHub();
    ...
    private void btnNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextActionPerformed
        ...
        lblComplete2.setText("Completed - " + coumplete + " %");
        reset();
        qustion();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(roundArea.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
