...
public class round extends javax.swing.JFrame {
    ...
    public void insertToSql() {
        ...
        try {
            ...
            PreparedStatement st1 = con.prepareStatement("UPDATE `smart_learning`.`maths` SET `roundComplete` = ?, `roundScore` = ? WHERE (`stRegId` = '"+idPas+"');");
            // execute query
    ...
    public void chack() {
        if (jTextField1.getText().equals("") && jTextField2.getText().equals("") && jTextField3.getText().equals("") && jTextField4.getText().equals("") && txtAnser.getText().equals("")) {
            ...
            if (count == 2) {
                ...
                if (txtAnser.getText().equals("176")) {
                    txtAnser.setBorder(BorderFactory.createLineBorder(Color.GREEN));
                    score = score + 5;
    ...
    private void initComponents() {
        ...
        lblMainObject.setText("Round Perimeter");
