 ...
 * @author mmamm
 */
public class TrangleSide extends javax.swing.JFrame {

    /**
     * Creates new form TrangleSide
     */
    JButton selectedTxt;
    ...
    public void insertToSql() {
        ...
        try {
            ...
            PreparedStatement st1 = con.prepareStatement("UPDATE `smart_learning`.`maths` SET `trangleSideComplete` = ?, `trangleSideScore` = ? WHERE (`stRegId` = '"+idPas+"');");
            // execute query
    ...
    private void initComponents() {
        ...
        lblUserName9.setText("Trangle  Engal");
        ...
        jButton2.setText("Trangle  Engal");
        ...
        lblImage2Layout.setVerticalGroup(
            lblImage2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(image2, javax.swing.GroupLayout.DEFAULT_SIZE, 268, Short.MAX_VALUE)
        );
        ...
        lblImage3Layout.setHorizontalGroup(
            ...
            .addComponent(image3, javax.swing.GroupLayout.DEFAULT_SIZE, 258, Short.MAX_VALUE)
        );
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(lblUname1, javax.swing.GroupLayout.DEFAULT_SIZE, 258, Short.MAX_VALUE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        Maths.TrangleAngal bch = new Maths.TrangleAngal();
        bch.setId(idPas);
        bch.show();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TrangleSide.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TrangleSide().setVisible(true);
            }
        });
    }
