 ...
 * @author mmamm
 */
public class base2intoBase8 extends javax.swing.JFrame {

    /**
     * Creates new form base2intoBase8
     */
    JTextField selectedTxt;

    public base2intoBase8() {
        initComponents();
        qustions();
    ...
    public void insertToSql() {
        ...
        try {
            ...
            PreparedStatement st1 = con.prepareStatement("UPDATE `smart_learning`.`ict` SET `base2intoBase8Score` = ?, `base2intoBase8Complete` = ? WHERE (`stRegId` = '" + idPas + "');");
            // execute query
...
//        jLabel4.setForeground(new Color(102, 102, 102));
    ...
    private void initComponents() {
        ...
        lblMainObject.setText("Base 2 into Base 8");
    ...
    private void BtnCheckActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCheckActionPerformed
        ...
        complete = complete + 6;
        lblComplete1.setText("Completed - " + complete + " %");
        chack();
    ...
    private void BtnCheck2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCheck2ActionPerformed
        ...
        if (jTextField1.getText().equals("") || jTextField2.getText().equals("") || ffAnswer.getText().equals("")) {
            ...
            //first chack
            String devid = String.valueOf(fanswer / 8);
            String bln = String.valueOf(fanswer % 8);
        ...
        if (fanswer >= 64) {
            if (jTextField3.getText().equals("") || jTextField4.getText().equals("") || ffAnswer.getText().equals("")) {
                ...
                String secondDiv = String.valueOf(get2nd / 8);
                String secondBlnce = String.valueOf(get2nd % 8);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(base2intoBase8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new base2intoBase8().setVisible(true);
            }
        });
    }
